...
const { getUserTeam, getTeamMembers, getTeamData } = require('../utils/user');
...
module.exports = Router()
  ...
  .get('/login/callback', async (req, res, next) => {
    try {
      ...
      // populate cohort table with orgTeams
      ...
      // if cohort exists, add user to that cohort_members
      ...
      // populate profile table with orgTeamMembers - login, avatar_url to auto generate

      // const orgTeamMembers = await getTeamMembers();
      // console.log('orgTeamMembers', orgTeamMembers);
