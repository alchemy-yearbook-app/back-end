...
VALUES 
    ...
    ('Asking for help', 'Coming from a highly competitive pre-med and pharmacy field, it was rare for students to help each other. People were gatekeeping information and keeping it for themselves. This is completely different in Alchemy. Do not be afraid to ask for help from classmates, instructors, staff, and TAs. Everyone is here to help you and it is always a safe learning environment.', 'Kevin Do', 'September 2021'), 
